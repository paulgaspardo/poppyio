...
You can also browse the contents of the package at https://js.poppy.io/0.0.2/
...
<script type='module'>
  import Poppy from "https://js.poppy.io/0.0.2/use-en.mjs";
...
```html
<script src="https://js.poppy.io/0.0.2/target/bundle/poppyio.en.min.js" nomodule></script>
<script nomodule>
...
```
  $ npm install https://js.poppy.io/0.0.2/poppyio-0.0.2.tgz
```
...
```html
  <script src="https://js.poppy.io/0.0.2/bundle/poppyio.en.js"></script>
```
